package es.jmoral.ozcomicreader.adapters;
...
import es.jmoral.ozcomicreader.custom.PaletteBitmap;
import es.jmoral.ozcomicreader.fragments.collection.CollectionView;
